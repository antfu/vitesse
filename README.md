...
- [vitesse-modular-naiveui](https://github.com/arijs/vitesse-modular-naiveui) by [@rhengles](https://github.com/rhengles) - Modular arch. with [NaiveUI](https://www.naiveui.com) component library integrated
